Ext.define('pxp.view.component.Lugar', {
       ...
       items: [
            {
                ...
                items: [
                   { 
                     ...
                     listeners: {
			                tap: function (searchField) {
			                    searchField.up('lugarcomp').onCancel();
			                 },
			                 scope: this
                   ...
                   { 
                   	  ...
                   	  listeners: {
			                action: function (searchField) {
			                    searchField.up('lugarcomp').onActiveFilter(searchField.getValue());
			                 },
			                clearicontap:function(searchField){
			                	searchField.up('lugarcomp').onClearFilter()
			                },
			                scope: this
			            }
                   ...
                   { 
                   	 ...
                   	 listeners: {
			                tap: function (searchField) {
			                    searchField.up('lugarcomp').onDone();
			                 },
			                scope: this
			            }
    ...
    initialize: function(){
       var me = this;
       me.store = Ext.create('pxp.store.Lugar');	
       me.add([
         {
            xtype: 'list',
            flex: 1,
