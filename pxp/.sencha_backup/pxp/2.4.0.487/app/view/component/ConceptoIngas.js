Ext.define('pxp.view.component.ConceptoIngas', {
    extend: 'Ext.Container',
    xtype: 'conceptoingascomp',
    requires: [
    ...
    config: {
    	...
    	valueField:'desc_ingas',
    	idField:'id_concepto_ingas',
        ui: 'detail',
        cmpText:undefined,
        cmpHidden:undefined,
       ...
       items: [
            {
                ...
                items: [
                   { 
                     ...
                     listeners: {
			                tap: function (searchField) {
			                    searchField.up('conceptoingascomp').onCancel();
			                 },
			                 scope: this
                   ...
                   { 
                   	  ...
                   	  listeners: {
			                action: function (searchField) {
			                    searchField.up('conceptoingascomp').onActiveFilter(searchField.getValue());
			                 },
			                clearicontap:function(searchField){
			                	searchField.up('conceptoingascomp').onClearFilter()
			                },
			                scope: this
			            }
                   ...
                   { 
                   	 ...
                   	 listeners: {
			                tap: function (searchField) {
			                    searchField.up('conceptoingascomp').onDone();
			                 },
			                scope: this
			            }
    ...
    initialize: function(){
       var me = this;
       me.store = Ext.create('pxp.store.ConceptoIngas');	
       me.add([
         {
            xtype: 'list',
            flex: 1,
    ...
    idColumn:'id_concepto_ingas',
    displayColumn:'desc_ingas',
    onDone:function(){
    	var me = this,
