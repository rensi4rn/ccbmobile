Ext.define('pxp.view.component.Gestion', {
       ...
       items: [
            {
                ...
                items: [
                   { 
                     ...
                     listeners: {
			                tap: function (searchField) {
			                    searchField.up('gestioncomp').onCancel();
			                 },
			                 scope: this
                   ...
                   { 
                   	  ...
                   	  listeners: {
			                action: function (searchField) {
			                    searchField.up('gestioncomp').onActiveFilter(searchField.getValue());
			                 },
			                clearicontap:function(searchField){
			                	searchField.up('gestioncomp').onClearFilter()
			                },
			                scope: this
			            }
                   ...
                   { 
                   	 ...
                   	 listeners: {
			                tap: function (searchField) {
			                    searchField.up('gestioncomp').onDone();
			                 },
			                scope: this
			            }
    ...
    initialize: function(){
       var me = this;
       me.store = Ext.create('pxp.store.Gestion');	
       me.add([
         {
            xtype: 'list',
            flex: 1,
